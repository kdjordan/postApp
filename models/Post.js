...
//require user to use getAvatar function
...
Post.prototype.validate = function() {
    if(this.data.title == '') { this.errors.push("You must provide a title for your Post."); }
...
Post.getFeed = async function(id) {
    //create an array of all followers for user
