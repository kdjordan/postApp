...
export default class Search {
    ...
    keyPressHandler() {
        ...
        if(value != '' && value != this.previousValue) {
            clearTimeout(this.typingWeightTimer);
            this.showLoaderIcon();
            this.hideResultsArea();
            this.typingWeightTimer = setTimeout(() => this.sendRequest(), 750);
        }
    ...
    renderResultsHTML(posts) {
        ...
        if(posts.length) {
            ...
            this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm ">Sorry, no results were found for your search </p>`
        }
        this.hideLoaderIcon();
