...
export default class RegistrationForm {
    ...
    passwordImmediately() {
        if(this.password.value.length > 50) {
            this.showValidationError(this.password, "Password length must be less than 50 chars");
        }
    ...
    passwordAfterDelay() {
        if(this.password.value.length < 5) {
            this.showValidationError(this.password, "Your password must be at least 5 characters");
        }
